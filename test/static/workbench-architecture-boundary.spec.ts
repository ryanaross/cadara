...
test('src/app/workbench-architecture-boundary.spec.ts', () => {  const offenders: string[] = []
...
test('src/app/workbench-architecture-boundary.spec.ts tool activation routing', () => {  const contextSource = readFileSync(join(ROOT, 'src/hooks/workbench-command-context.ts'), 'utf8')
