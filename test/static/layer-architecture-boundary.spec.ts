...
test('src/layer-architecture-boundary.spec.ts migrated compatibility entrypoints stay deleted', () => {  const removedEntrypoints = [
...
test('src/layer-architecture-boundary.spec.ts core domain dependency debt stays explicit', () => {  const allowedCoreDomainImports = new Set([
