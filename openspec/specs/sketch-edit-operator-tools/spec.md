# sketch-edit-operator-tools Specification

## Purpose
Define selection-driven sketch edit operators that mutate or derive geometry inside an active sketch while remaining distinct from part-mode solid feature tools.
