# section-view-inspection Specification

## Purpose
Define temporary section-view behavior for explicit planar seeds, normal-constrained manipulation, whole-model clipping, and cut-surface rendering without mutating durable model geometry.
