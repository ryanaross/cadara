...
Define the required separation between frontend editor behavior, the frontend-facing modeling service boundary, and interchangeable kernel implementations.
