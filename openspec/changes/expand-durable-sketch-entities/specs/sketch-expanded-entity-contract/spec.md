...
The system SHALL represent ellipse, elliptical arc, conic, Bezier curve, and profile-generating text as explicit authored sketch entity kinds rather than approximating them as existing line, arc, circle, or spline records in durable sketch state.

#### Scenario: Advanced entity is persisted
- **WHEN** a sketch definition contains an ellipse, elliptical arc, conic, Bezier curve, or profile-generating text entity with valid defining data
...
- **WHEN** a sketch definition contains an advanced entity with missing defining points, invalid radii, invalid weights, invalid text content, or otherwise invalid parameters
