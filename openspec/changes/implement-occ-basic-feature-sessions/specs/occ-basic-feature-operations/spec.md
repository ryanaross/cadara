...
Define the remaining basic solid-feature operations that the modeling contract and the OpenCascade-backed adapter must support for preview and committed rebuilds.
