import type { AppError, ErrorReportMetadata, ErrorReporter } from '@/contracts/errors'
...
export function handleWorkbenchFailure(input: WorkbenchFailurePolicyInput): AppError {
