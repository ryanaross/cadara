import type { CadaraDebugNamespace, DeveloperDebugSession, EditorRuntimeTraceSnapshot, WorkbenchDebugState } from '@/domain/debug/debug-platform'

export function isCadaraDebugPlatformEnabled(input: {
  dev: boolean
  test?: boolean | string
} = {
