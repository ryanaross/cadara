...
export const workbenchShellTokens = {
  panelShadow:
    "0 24px 48px rgba(0, 0, 0, 0.48), 0 8px 20px rgba(0, 0, 0, 0.30), inset 0 1px 0 rgba(255, 255, 255, 0.06)",
  pillShadow:
    "0 6px 16px rgba(0, 0, 0, 0.45), 0 4px 12px rgba(0, 0, 0, 0.30), inset 0 1px 0 rgba(255, 255, 255, 0.06)",
  fabShadow:
    "0 10px 20px rgba(0, 0, 0, 0.45), 0 6px 14px rgba(0, 0, 0, 0.30), inset 0 1px 0 rgba(255, 255, 255, 0.07)",
...
export const workbenchCssVariablesResolver: CSSVariablesResolver = (theme) => {
  ...
  return {
    ...
    variables: {
      ...
      "--workbench-shell-inner-highlight":
      ...
      "--workbench-icon-drop-shadow-canvas":
      ...
      "--workbench-toolbar-button-hover-background":
      ...
      "--workbench-toolbar-button-press-background":
      ...
      "--workbench-shell-surface-panel":
        "var(--workbench-shell-surface-strong)",
      ...
      "--workbench-shell-sidebar-item-selected-icon":
        "var(--mantine-color-dark-1)",
      "--workbench-shell-accent": "var(--mantine-color-workbench-4)",
      "--workbench-shell-accent-surface":
        "var(--mantine-color-workbench-light)",
      "--workbench-shell-accent-surface-hover":
        "var(--mantine-color-workbench-light-hover)",
      ...
      "--workbench-geometry-highlight-hover":
        workbenchGeometryHighlightColors.hover.css,
      "--workbench-geometry-highlight-selected":
        workbenchGeometryHighlightColors.selected.css,
      "--workbench-geometry-highlight-hover-emissive":
        workbenchGeometryHighlightColors.hoverEmissive.css,
      "--workbench-geometry-highlight-selected-emissive":
        workbenchGeometryHighlightColors.selectedEmissive.css,
      "--workbench-notification-surface":
        "var(--workbench-shell-overlay-strong)",
      "--workbench-notification-text": "var(--workbench-shell-text)",
      "--workbench-notification-text-muted":
        "var(--workbench-shell-text-muted)",
      "--workbench-notification-info-accent": "var(--workbench-shell-accent)",
      "--workbench-notification-info-border":
        "var(--workbench-shell-accent-border)",
      "--workbench-notification-info-title":
        "var(--workbench-shell-accent-text)",
      "--workbench-notification-warning-accent":
        "var(--workbench-shell-warning-border)",
      "--workbench-notification-warning-border":
        "var(--workbench-shell-warning-border)",
      "--workbench-notification-warning-title":
        "var(--workbench-shell-warning-text)",
      "--workbench-notification-error-accent":
        "var(--workbench-shell-danger-border)",
      "--workbench-notification-error-border":
        "var(--workbench-shell-danger-border)",
      "--workbench-notification-error-title":
