...
test('src/components/cad/sketch-tool-panel.spec.tsx', () => {
  ...
  expectTrue(markup.includes('Pick the starting point.'), 'Sketch tool panels should render active tool prompts.')
  expectTrue(
  ...
  expectTrue(
    markup.includes('z-20') && markup.includes('pointer-events-none') && !markup.includes('left-4 top-4'),
