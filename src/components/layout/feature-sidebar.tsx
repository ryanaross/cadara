...
const defaultSidebarAccordionValues = [
  "objects",
  "variables",
  "diagnostics",
] as const;
            ...
            <Accordion.Panel className="pb-4">
              <div>
                {(snapshot?.presentation.objects ?? []).map((item) => {
                  ...
                  const itemLabel =
                    objectLabelOverrides[targetKey] ?? item.label;
                    ...
                    >
                      ...
                      >
                        ...
                        <ActionIcon
                          ...
                          size={24}
                          aria-label={
                            isHidden ? `Show ${itemLabel}` : `Hide ${itemLabel}`
                          }
                          title={
              ...
              <div className="space-y-1 px-3">
                {(snapshot?.document.variables ?? []).map((variable) => {
                  ...
                  const accessibleVariableName =
                    getVariableAccessibleName(variable);
                  const variableResult = variableResultPresentations.get(
                    variable.variableId,
                  ) ?? {
                    kind: "error",
                  ...
                  return (
                    <div
                      ...
                      data-variable-editing={
                        isEditingVariable ? "true" : undefined
                      }
                      style={{
                  ...
                  snapshot.document.diagnostics.map((diagnostic, index) => {
                    ...
                    const menuItems: WorkbenchContextMenuEntry[] = [
                      ...
                      },
                      {
                        ...
                        icon: (
                          <WorkbenchIcon name="info" className="h-3.5 w-3.5" />
                        ),
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          <p className="mt-1 text-xs text-[var(--workbench-shell-text-dim)]">
                            {diagnostic.code}
                          </p>
                        </div>
                      </WorkbenchContextMenu>
