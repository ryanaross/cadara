...
export function WorkbenchNotification({
  ...
  useEffect(() => {
    ...
    return (
      scheduleWorkbenchNotificationAutoDismiss(type, onDismiss) ?? undefined
    );
  }, [onDismiss, type]);
  ...
  return (
    ...
    >
      <Box
        ...
        style={{
          backgroundColor: "var(--workbench-notification-active-accent)",
        }}
      />
...
function getPlacementClassName(
  placement: WorkbenchNotificationPlacement | undefined,
) {
