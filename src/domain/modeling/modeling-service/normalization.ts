...
export function normalizeSketchPlaneKey(value: unknown): SketchPlaneDefinition['key'] {
  if (value === null) {
    return null
  }
...
export function normalizeSketchPlaneDefinition(value: unknown): SketchPlaneDefinition {
...
export function normalizePoint3(value: unknown): readonly [number, number, number] {
...
export function normalizeExtrudeFeatureParameters(value: unknown): ExtrudeFeatureParameters {
  if (!isRecord(value)) {
...
export function normalizeFilletFeatureParameters(value: unknown): FilletFeatureParameters {
...
export function normalizePlaneFeatureParameters(value: unknown): PlaneFeatureParameters {
...
export function normalizeRevolveFeatureParameters(value: unknown): RevolveFeatureParameters {
  if (!isRecord(value)) {
...
export function normalizeShellFeatureParameters(value: unknown): ShellFeatureParameters {
...
export function normalizeAdvancedSolidFeatureParameters(value: unknown): AdvancedSolidFeatureParameters {
...
export function normalizeInvalidReferenceDetail(value: unknown): InvalidReferenceDetailPayload {
...
export function normalizeDiagnosticDetail(value: unknown): ModelingDiagnosticDetail {
...
export function normalizeDocumentHistory(value: unknown): DocumentHistoryItemRecord[] {
  if (!Array.isArray(value)) {
...
export function normalizeDocumentVariables(value: unknown): DocumentVariableRecord[] {
  if (!Array.isArray(value)) {
...
export function normalizeProjectedSketchReferences(value: unknown): ProjectedSketchReferenceRecord[] {
  if (!Array.isArray(value)) {
...
export function normalizeProjectedSketchReferenceGeometry(value: unknown): ProjectedSketchReferenceGeometry {
...
export function normalizePoint2D(value: unknown, errorMessage: string): SketchPoint2D {
...
export function normalizeSketchStyleDefinition(value: unknown): SketchStyleDefinition | undefined {
  if (value === undefined) {
    return undefined
  }
...
export function normalizeSketchStyleFill(value: Record<string, unknown>): SketchStyleRecord['fill'] {
  if (value.kind === 'none') {
    return { kind: 'none' }
  }
...
export function normalizeSketchStyleStroke(value: Record<string, unknown>): SketchStyleRecord['stroke'] {
  if (
...
export function normalizeSketchDerivationOutput(value: unknown): SketchDerivationDefinition['outputs'][number] {
  if (
    !isRecord(value) ||
...
export function normalizeSketchDerivationDefinition(value: unknown): SketchDerivationDefinition {
  if (
    !isRecord(value) ||
...
export function normalizeSketchReferenceDefinition(value: unknown): SketchReferenceDefinition {
...
export function normalizeSketchPointDefinition(value: unknown): SketchPointDefinition {
  if (
    !isRecord(value) ||
...
export function normalizeSketchEntityDefinition(value: unknown): SketchEntityDefinition {
...
export function normalizeConstraintDefinition(value: unknown): ConstraintDefinition {
...
export function normalizeDimensionDefinition(value: unknown): DimensionDefinition {
...
export function normalizeSolvedSketchSnapshot(value: unknown): SolvedSketchSnapshot {
  if (
    !isRecord(value) ||
...
export function normalizeSolvedSketchEntityGeometry(value: unknown): SolvedSketchSnapshot['solvedEntities'][number] {
...
export function normalizeConstraintStatusRecord(value: unknown): ConstraintStatusRecord {
  if (
    !isRecord(value) ||
...
export function normalizeDimensionStatusRecord(value: unknown): DimensionStatusRecord {
  if (
    !isRecord(value) ||
...
export function normalizeSketchSolveDiagnostic(value: unknown): SketchSolveDiagnostic {
  if (
    !isRecord(value) ||
    !isString(value.code) ||
...
export function normalizeConstructions(value: unknown): ConstructionSnapshotRecord[] {
  if (!Array.isArray(value)) {
...
export function normalizeKernelDocumentSnapshot(value: unknown): KernelDocumentSnapshot {
