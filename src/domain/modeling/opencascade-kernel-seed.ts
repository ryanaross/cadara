...
export const OCC_KERNEL_CAPABILITIES: ModelingKernelCapabilities = {
  supportedFeatureKinds: ['extrude', 'fillet', 'plane', 'revolve', 'shell', 'sweep', 'loft', 'chamfer'],
  previewableFeatureKinds: ['extrude', 'fillet', 'plane', 'revolve', 'shell', 'sweep', 'loft', 'chamfer'],
