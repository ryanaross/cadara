...
export const OCC_KERNEL_CAPABILITIES: ModelingKernelCapabilities = {
  supportedFeatureKinds: ['extrude', 'fillet', 'plane', 'revolve', 'shell', 'stepImport', 'meshImport', 'sweep', 'loft', 'chamfer', 'thicken', 'combine', 'split', 'deleteSolid'],
  previewableFeatureKinds: ['extrude', 'fillet', 'plane', 'revolve', 'shell', 'stepImport', 'meshImport', 'sweep', 'loft', 'chamfer', 'thicken', 'combine', 'split', 'deleteSolid'],
