import type { FeatureBooleanOperation, FeatureBooleanScope, RevolveAxisRef } from '@/contracts/modeling/schema'
...
export const OCC_CONTRACT_GAP_CODES = {
  constructionPlaneGeometryUnavailable: 'occ-contract-gap-construction-plane-geometry',
  constructionRevolveAxisUnsupported: 'occ-contract-gap-revolve-construction-axis',
...
} as const satisfies Record<Exclude<FeatureBooleanOperation, 'newBody'>, OccMultiBodyBooleanPolicy>
...
export function getProjectedRegionLoopRejectionReason() {
  return OCC_PHASE0_IMPLEMENTATION_NOTES.contractGaps.projectedGeometryRegionLoops
}
