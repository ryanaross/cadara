...
function createSketchConstraintRef(sketchId: SketchId, constraintId: string): PrimitiveRef {
  return { kind: 'constraint', sketchId, constraintId: constraintId as import('@/contracts/shared/ids').ConstraintId }
}

function createSketchDimensionRef(sketchId: SketchId, dimensionId: string): PrimitiveRef {
  return { kind: 'dimension', sketchId, dimensionId: dimensionId as import('@/contracts/shared/ids').DimensionId }
}

function createSketchEntityRef(sketchId: SketchId, entityId: string): PrimitiveRef {
  return { kind: 'sketchEntity', sketchId, entityId: entityId as import('@/contracts/shared/ids').SketchEntityId }
}

function createSketchPointRef(sketchId: SketchId, pointId: string): PrimitiveRef {
  return { kind: 'sketchPoint', sketchId, pointId: pointId as import('@/contracts/shared/ids').SketchPointId }
}
