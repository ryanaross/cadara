        ...
        diagnostics: [
          {
            ...
            severity: "error",
            message:
              "3MF export could not produce triangles for the selected body.",
            target,
          },
        ],
      };
...
export const threeMfExportProvider: ExportProvider<
...
> = {
  ...
  export(
    input: ExportProviderInput<ThreeMfExportOptions>,
  ): ExportProviderResult {
    return exportThreeMf(
      input.target,
      input.targetLabel,
      input.options,
      input.capabilities,
