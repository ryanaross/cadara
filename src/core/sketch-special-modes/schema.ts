...
export interface SketchSpecialModeSelectionContext<
  TState = unknown,
...
export interface SketchSpecialModeSelectionContract<TState = unknown> {
  ...
  resolveTarget?(
    input: SketchSpecialModeSelectionContext<TState>,
  ): SketchSpecialModeTargetRef | null;
  acceptsTarget?(input: SketchSpecialModeSelectionContext<TState>): boolean;
}

export interface SketchSpecialModePointerContext<
  TState = unknown,
> extends SketchSpecialModeLifecycleContext<TState> {
  point: SketchPoint;
...
export interface SketchSpecialModeHoverContext<
  TState = unknown,
> extends SketchSpecialModeLifecycleContext<TState> {
  target: PrimitiveRef | null;
  resolvedTarget: SketchSpecialModeTargetRef | null;
...
export interface SketchSpecialModePanelActionContext<
  TState = unknown,
> extends SketchSpecialModeLifecycleContext<TState> {
  action: SketchSpecialModePanelAction;
}

export interface SketchSpecialModeHandleDragContext<
  TState = unknown,
> extends SketchSpecialModeLifecycleContext<TState> {
  handle: SketchSpecialModeHandleRef;
  point: SketchPoint;
...
export interface SketchSpecialModeEffectContext<
  TState = unknown,
> extends SketchSpecialModeLifecycleContext<TState> {
  effectId: string;
  payload: Record<string, unknown>;
...
export interface SketchSpecialModeDefinition<TState = unknown> {
  ...
  ): SketchSpecialModeOpenRequest | null;
  enter(input: {
    sketchSession: SketchSessionState;
    operationTarget: SketchOperationRef;
    payload?: Record<string, unknown>;
  ...
  handleHover?(
    input: SketchSpecialModeHoverContext<TState>,
  ): SketchSpecialModeTransition<TState>;
  handleClick?(
    input: SketchSpecialModePointerContext<TState>,
  ): SketchSpecialModeTransition<TState>;
  handleDoubleClick?(
    input: SketchSpecialModePointerContext<TState>,
  ): SketchSpecialModeTransition<TState>;
  handleDragStart?(
    input: SketchSpecialModeHandleDragContext<TState>,
  ): SketchSpecialModeTransition<TState>;
  handleDragMove?(
    input: SketchSpecialModeHandleDragContext<TState>,
  ): SketchSpecialModeTransition<TState>;
  ...
  handlePanelAction?(
    input: SketchSpecialModePanelActionContext<TState>,
  ): SketchSpecialModeTransition<TState>;
  commit?(
    input: SketchSpecialModeLifecycleContext<TState>,
  ): SketchSpecialModeTransition<TState>;
  ...
  handleEffectResult?(
    input: SketchSpecialModeEffectContext<TState>,
  ): SketchSpecialModeTransition<TState>;
