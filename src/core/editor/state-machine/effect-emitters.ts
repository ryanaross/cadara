    ...
    effects: [
      {
        ...
        preserveRenderRecordsOnFeatureDiagnostics:
          options.preserveRenderRecordsOnFeatureDiagnostics,
      },
    ],
  };
}

export function getSnapshotMutationBasis(
  state: EditorState,
): SnapshotMutationBasis | null {
...
export function emitEditSessionCursorRestore(
  state: EditorState,
): EditorTransitionResult {
...
export function emitFeaturePreview(
...
export function emitFeatureCommit(
  state: FeatureEditorState,
): EditorTransitionResult {
  const mutationBasis = getSnapshotMutationBasis(state);
...
export function emitSketchPlaneCommit(
...
export function emitSketchCommit(
