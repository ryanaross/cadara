...
function buildRectanglePreview(
  ...
  const { bottomLeft, bottomRight, topRight, topLeft } = getRectangleCorners(
    start,
    end,
  );
...
function buildRectanglePresentation(
  ...
  return {
    ...
    steps: [
      {
        id: "rectangle-step",
        label: isDrawing ? "Opposite corner" : "First corner",
      },
    ],
    controls: [
      {
    ...
    measurements: isDrawing
      ? [
          {
            id: "rectangle-width-measure",
            label: "Width",
            value: widthValue,
            unit: "mm",
          },
          {
            id: "rectangle-height-measure",
            label: "Height",
            value: heightValue,
            unit: "mm",
          },
        ...
        return {
          points: [
            factories.createPoint(
              `Rectangle ${sequence} bottom left`,
              cornerIds[0],
              bottomLeft,
            ),
            factories.createPoint(
              `Rectangle ${sequence} bottom right`,
              cornerIds[1],
              bottomRight,
            ),
            factories.createPoint(
              `Rectangle ${sequence} top right`,
              cornerIds[2],
              topRight,
            ),
            factories.createPoint(
              `Rectangle ${sequence} top left`,
              cornerIds[3],
              topLeft,
            ),
          ],
          entities: [
            factories.createLineEntity(
              `Rectangle ${sequence} bottom`,
              entityIds[0],
              cornerIds[0],
              cornerIds[1],
            ),
            factories.createLineEntity(
              `Rectangle ${sequence} right`,
              entityIds[1],
              cornerIds[1],
              cornerIds[2],
            ),
            factories.createLineEntity(
              `Rectangle ${sequence} top`,
              entityIds[2],
              cornerIds[2],
              cornerIds[3],
            ),
            factories.createLineEntity(
              `Rectangle ${sequence} left`,
              entityIds[3],
              cornerIds[3],
              cornerIds[0],
            ),
