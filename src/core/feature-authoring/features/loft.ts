...
import { createSelectionFilterForRequirement, primitiveRefEquals, loftSelectionFilter, type PrimitiveRef } from '@/core/editor/schema'
import type { FeatureAuthoringDefinition, LoftFeatureParameterDraft } from '@/core/feature-authoring/definition'
import {
  acceptAuthoredPatch,
  appendUniqueTarget,
  asBodyRef,
