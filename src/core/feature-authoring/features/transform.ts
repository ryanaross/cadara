...
import type { FeatureAuthoringDefinition, TransformFeatureParameterDraft } from '@/core/feature-authoring/definition'
import { createSelectionFilterForRequirement, transformSelectionFilter, type PrimitiveRef } from '@/core/editor/schema'
import {
  acceptAuthoredPatch,
  appendUniqueTarget,
  asBodyRef,
