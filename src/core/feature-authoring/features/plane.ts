...
import { createSelectionFilterForRequirement, planeSelectionFilter } from '@/core/editor/schema'
import { PLANE_FEATURE_SCHEMA_VERSION } from '@/contracts/shared/versioning'
import { asPlaneReferenceTarget, createMissingInputDiagnostic } from '@/core/feature-authoring/features/shared'
    ...
    return {
      referenceTarget:
        patch.referenceTarget === undefined
          ...
          : asPlaneReferenceTarget(patch.referenceTarget as Parameters<typeof asPlaneReferenceTarget>[0]),
    }
  },
    ...
    return {
      sections: [
        ...
        },
        {
          id: 'diagnostics',
          title: 'Diagnostics',
          fields: [{ kind: 'diagnostics', id: 'plane-diagnostics', label: 'Diagnostics', diagnostics: session.diagnostics }],
        },
      ],
    }
  },
