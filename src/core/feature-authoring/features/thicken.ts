...
import type { FeatureAuthoringDefinition, ThickenFeatureParameterDraft } from '@/core/feature-authoring/definition'
import { createSelectionFilterForRequirement, thickenSelectionFilter, type PrimitiveRef } from '@/core/editor/schema'
import { acceptAuthoredPatch, appendUniqueTarget, asBodyRef, asFaceRef, authoredDefinitionValue, authoredNumberFormValue, authoredNumberLiteral, authoredStringLiteral, createMissingInputDiagnostic, expressionCapableAuthoredValue, isPositiveAuthoredNumber } from '@/core/feature-authoring/features/shared'
