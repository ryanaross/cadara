import { createConsoleErrorReporter, type ErrorReporter } from '@/contracts/errors/reporter'
import {
...
export function createDefaultErrorReporter(options: DefaultErrorReporterOptions): ErrorReporter {
