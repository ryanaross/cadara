...
export interface ErrorReporter {
  report(error: AppError, metadata: ErrorReportMetadata): ErrorReportRecord | null
}
...
export function createConsoleErrorReporter(consoleLike: ConsoleLike = console): ErrorReporter {
...
export function createTestErrorReporter(): ErrorReporter & { reports: ErrorReportRecord[] } {
...
export function createCompositeErrorReporter(reporters: readonly ErrorReporter[]): ErrorReporter {
  return {
    report(error, metadata) {
