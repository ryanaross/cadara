...
export function createLocalStorageDocumentRepositoryUrlStore(
  ...
  function read() {
    ...
    try {
      ...
      const validated = parseAutomergeDocumentUrlStorePayload(
        parsed,
        isValidAutomergeUrl,
      );
...
export function createDocumentRepositoryUrlStorageKey(
  namespace: string = DEFAULT_DOCUMENT_REPOSITORY_NAMESPACE,
) {
