...
export type EditorEventLoopTraceListener = (
  entry: EditorRuntimeTraceEntry,
) => void;
...
export function createEditorDebugTraceRecorder(
  maxEntries = DEFAULT_TRACE_ENTRY_LIMIT,
): EditorDebugTraceRecorder {
...
export function createEmptyEditorRuntimeTraceSnapshot(
  maxEntries = DEFAULT_TRACE_ENTRY_LIMIT,
): EditorRuntimeTraceSnapshot {
  return {
    maxEntries,
